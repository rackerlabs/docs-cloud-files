...
exclude_patterns = ['_build', 'samples', 'cdn-api-operations/methods*', 'storage-api-operations/methods*']
...
html_title = 'Rackspace Cloud Files version 1.0 API Developer Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Files'
...
htmlhelp_basename = 'RackspaceCloudApiFilesDeveloperDoc'
...
latex_documents = [
  ('index', 'RackspaceCloudApiFilesDeveloperDoc.tex', 'Rackspace Cloud Files API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCloudApiFilesDeveloperDoc', 'Rackspace Cloud Files API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCloudApiFilesDeveloperDoc', 'Rackspace Cloud Files API Developer Guide',
   'Rackspace', 'RackspaceCloudApiFilesDeveloperDoc', 'Learn about using the REST API for the Rackspace Cloud Files service.',
   'Miscellaneous'),
]
