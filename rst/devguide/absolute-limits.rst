...
+=======================+==================================+====================+
| Containers per        | Maximum number of containers     | 500,000 containers |
| account               | per account                      |                    |
+-----------------------+----------------------------------+--------------------+
...
| large object (SLO)    |                                  |                    |
+-----------------------+----------------------------------+--------------------+
| TTL for a CDN-enabled | Maximum TTL for a CDN-enabled    | 1 year (31,536,000 |
| container             | container                        | seconds)           |
+-----------------------+----------------------------------+--------------------+
