...
.. *2012-05-14 dsh: Added for 2012-05-14 release*

This chapter describes how to use your CDN-enabled containers to create static
...
website by creating pseudo directories, as outlined in `??? <>`__. Each
...
..
   2013-08-23 cyr: Added based on email from Rick Hawkins: "Specifically
   these are the headers relating to Static Web which I did not find in our
...
..
   *2012-08-13 dsh: Added to clarify CNAME based on Disqus comments *\ 
...
#. Set the index (or primary page) for your website by performing a
   **POST** request to the header ``X-Container-Meta-Web-Index`` on your
   website's container. See `Example 2.1, “Set up static
   web” fixmefixmefixme#setUpStaticWebEx>`__. (Remember to change the
...
#. CDN-enable your container as shown in `??? <>`__.
