...
`Request <GET_list_cdn-enabled_containers_v1_account_.rst#request>`__
`Response <GET_list_cdn-enabled_containers_v1_account_.rst#response>`__
...
|                          |                         |Theinformation returned  |
|                          |                         |with the response is     |
|                          |                         |dependent onthe method   |
|                          |                         |used in the request.     |
+--------------------------+-------------------------+-------------------------+
