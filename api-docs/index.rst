...
understanding of the :how-to:`Cloud Files FAQ<cloud-files-faq>`
and have a `Rackspace Cloud account`_ with access to the Cloud
Files service. You should also be familiar with the following technologies:
