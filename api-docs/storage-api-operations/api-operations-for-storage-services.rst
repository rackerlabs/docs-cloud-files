...
All requests are directed to the endpoints described in the cloudFiles section
of the service catalog obtained during successful authentication. (For more
information, see
:ref:`Authentication<auth>` and :ref:`Service access endpoints<service-access>`.)
