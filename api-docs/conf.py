...
project = 'Rackspace Cloud Files v1.0'
...
exclude_patterns = ['_build', 'samples',
                    ...
                    'cdn-api-reference/methods/*',
                    'storage-api-reference/methods/*',
                    'cdn-api-reference/additional/*',
                    'storage-api-reference/additional/*',
                    'use-cases/static-websites-using-cdn-enabled-containers/*',
                    'use-cases/public-access-to-your-cloud-files-account/*',
...
html_title = 'Rackspace Cloud Files v1.0 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Files v1.0 API'
...
htmlhelp_basename = 'docs-cloud-files'
...
latex_documents = [
  (master_doc, 'docs-cloud-files.tex',
   'Rackspace Cloud Files API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Cloud Files API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-files', 'Rackspace Cloud Files API Documentation',
   'Rackspace', 'docs-cloud-files', 'Learn about using the Product',
   'Miscellaneous'),
]
